...
#ifndef nsDrawingSurfaceCurses_h___
#define nsDrawingSurfaceCurses_h___

#include "nsIDrawingSurface.h"

class nsDrawingSurfaceCurses : public nsIDrawingSurface
{
	public:
		nsDrawingSurfaceCurses();
		virtual ~nsDrawingSurfaceCurses();
