...
#ifndef nsDeviceContextCurses_h___
#define nsDeviceContextCurses_h___
...
class nsDeviceContextCurses : public DeviceContextImpl
{
	public:
		nsDeviceContextCurses();
		virtual ~nsDeviceContextCurses();
		...
		NS_IMETHOD  CreateRenderingContext(nsIWidget *aWidget,
						   nsIRenderingContext *&aContext)
			{return (DeviceContextImpl::CreateRenderingContext(aWidget,aContext));}
		NS_IMETHOD  CreateRenderingContext(nsIDrawingSurface* aSurface,
						   nsIRenderingContext *&aContext)
...
#endif /* nsDeviceContextCurses_h___ */
